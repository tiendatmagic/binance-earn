    ...
    <div
      ...
      <div
        ...
        <div style="display: flex; color: #fff;align-items: center;">
          <svg _ngcontent-ng-c274460606="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5120 1024"
            fill="currentColor" class="header-logo text-[#F0B90B] h-6" style="color: #F0B90B; height: 1.5rem;">
            <path _ngcontent-ng-c274460606=""
      ...
      <div
        ...
        <p style="margin-top:0;margin-bottom:14px;color: #000;">Địa chỉ ví: {{ $address }}</p>

        <p style="font-size:28px;margin-top:20px;margin-bottom:20px;color:#F0B90B;font-weight:600;">{{ $code }}</p>
        <p style="margin-top:0;margin-bottom:0;color: #000;">Trân trọng,</p>
